 ...
 *      $Source: $
 *      $State: $
 *      $Modified: Ver 1.02  1996-09-25 1byte カナコード殲滅作戦
 *                                      コンパイルオプション変更(-div=cpu)
 ...
 *
 *  MOD HISTORY:
 *     1995.12.13 csh_main.c ライン境界対策
 *     1995.07.26 csh_main.c 高橋智延 わかりにくいから変更(?!)
 *      $Modified: Ver 1.02  1996-09-25 1byte カナコード殲滅作戦
 *                                      コンパイルオプション変更(-div=cpu)
 *
 *
...
void CSH_Purge(void *adrs, Uint32 P_size)
{
	...
	*/
	...
	adrs = (void *)((Uint32)adrs
	 & 0x1ffffff0 | 0x40000000);				/*	先頭インバリデートアドレス作成	*/
