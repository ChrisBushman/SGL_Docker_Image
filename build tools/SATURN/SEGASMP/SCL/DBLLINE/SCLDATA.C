...
void FirstData(Uint32 sclnum)
{
    ...
    for(i=0;i<16;i++)
    {
	MapCopyforVRAM((void *)char_ram             ,
						(void *) &grandu_map[i*16], Offset, 16*2);
	MapCopyforVRAM((void *)(char_ram+16*4)      ,
						(void *) &grandu_map[i*16],Offset,16*2);
	MapCopyforVRAM((void *)(char_ram+32*4)      ,
						(void *) &grandu_map[i*16],Offset,16*2);
	MapCopyforVRAM((void *)(char_ram+48*4)      ,
						(void *) &grandu_map[i*16],Offset,16*2);
	MapCopyforVRAM((void *)(char_ram+4096)      ,
						(void *) &grandu_map[i*16],Offset,16*2);
	MapCopyforVRAM((void *)(char_ram+4096+16*4) ,
						(void *) &grandu_map[i*16],Offset,16*2);
	MapCopyforVRAM((void *)(char_ram+4096+32*4) ,
						(void *) &grandu_map[i*16],Offset,16*2);
	MapCopyforVRAM((void *)(char_ram+4096+48*4) ,
						(void *) &grandu_map[i*16],Offset,16*2);
	MapCopyforVRAM((void *)(char_ram+8192)      ,
						(void *) &grandu_map[i*16],Offset,16*2);
	MapCopyforVRAM((void *)(char_ram+8192+16*4) ,
						(void *) &grandu_map[i*16],Offset,16*2);
	MapCopyforVRAM((void *)(char_ram+8192+32*4) ,
						(void *) &grandu_map[i*16],Offset,16*2);
	MapCopyforVRAM((void *)(char_ram+8192+48*4) ,
						(void *) &grandu_map[i*16],Offset,16*2);
	MapCopyforVRAM((void *)(char_ram+12288)     ,
						(void *) &grandu_map[i*16],Offset,16*2);
	MapCopyforVRAM((void *)(char_ram+12288+16*4),
						(void *) &grandu_map[i*16],Offset,16*2);
	MapCopyforVRAM((void *)(char_ram+12288+32*4),
						(void *) &grandu_map[i*16],Offset,16*2);
	MapCopyforVRAM((void *)(char_ram+12288+48*4),
						(void *) &grandu_map[i*16],Offset,16*2);
