...
/*	SCL_SetColRamMode(SCL_CRM15_2048);*/
	...
	*******************************************/
	...
	tp.vramA0     = SCL_RBG0_CHAR;	/* VRAM A0 にRBG0のBitMapデータを置く */
	tp.vramA1     = SCL_RBG0_K;	/* VRAM A1 に回転パラメータ係数テーブルを置く */
/*	tp.colram     = SCL_RBG0_K;*/	/* カラーRAMに回転パラメータ係数テーブルを置く */
