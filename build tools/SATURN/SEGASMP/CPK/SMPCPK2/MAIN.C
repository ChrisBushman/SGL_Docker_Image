...
*
*		ストリームシステムを使ってＣＤ上のムービファイルを再生するサンプル
...
/* リングバッファ */
Uint32 g_movie_buf[RING_BUF_SIZ / sizeof(Uint32)];

/* 再生するムービファイル名 */
#if 0
static char *filename = "SAMPLE.CPK";
#else
static char *filename = "OPENINGA.CPK";
#endif

#define	NO_WAIT_SPREND	0
#define	YES_WAIT_SPREND	1
#define	WAIT_SPREND 	YES_WAIT_SPREND
...
{
#if WAIT_SPREND == YES_WAIT_SPREND
...
/* ムービハンドル生成 */
static CpkHn createMovie(StmHn stm)
{
