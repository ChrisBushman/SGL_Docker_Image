...
/* ファイル情報の取得 */
GFS_LOCAL void  gfs_GetFinfo(GfsFlow *flow, Sint32 *fid, Sint32 *fad,
...
/* バージョン番号   */
const Sint8   gfs_version[GFS_VERSION_SIZ] = GFS_VERSION_STR;
 ...
 *  
 *****************************************************************************/
void gfs_GetFinfo(GfsFlow *flow, Sint32 *fid, Sint32 *fad,
                         Sint32 *sctsiz, Sint32 *nsct, Sint32 *lastsiz,
                         Sint32 *fno, Sint32 *atr)
{
    GfsFinfo    *finfo;
